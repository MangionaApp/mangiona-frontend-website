    ...
    <div class="footer">
      <div class="footer-grid">
        ...
        <div class="footer-col app-col">
          ...
          <div class="footer-socials" aria-label="Mangiona social media"><a href="https://www.instagram.com/mangiona.ap?utm_source=qr&amp;igsh=MWlkbDA2ZWlxOGZ1Mg%3D%3D" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><iconify-icon icon="mdi:instagram"></iconify-icon></a><a href="https://x.com/MangionaApp" target="_blank" rel="noopener noreferrer" aria-label="X"><iconify-icon icon="ri:twitter-x-fill"></iconify-icon></a><a href="https://www.facebook.com/share/1EHm4EtfY9/" target="_blank" rel="noopener noreferrer" aria-label="Facebook"><iconify-icon icon="mdi:facebook"></iconify-icon></a></div>
        </div>
      </div>
      <hr class="footer-hr">
